...
-- To add additional constranits to judicial_office_authorisation

ALTER TABLE dbjudicialdata.judicial_office_authorisation ADD CONSTRAINT per_id_fk FOREIGN KEY (per_id)
REFERENCES dbjudicialdata.judicial_user_profile(per_id);

-- To add additional constranits to judicial_office_appointment
ALTER TABLE dbjudicialdata.judicial_office_appointment ADD CONSTRAINT per_id_fk
FOREIGN KEY (per_id) REFERENCES dbjudicialdata.judicial_user_profile(per_id);

ALTER TABLE dbjudicialdata.judicial_office_appointment ADD CONSTRAINT base_location_id_fk1
FOREIGN KEY (base_location_id) REFERENCES dbjudicialdata.base_location_type(base_location_id);

ALTER TABLE dbjudicialdata.judicial_office_appointment ADD CONSTRAINT region_id_fk1
FOREIGN KEY (region_id) REFERENCES dbjudicialdata.region_type(region_id);

-- To add additional constranits to judicial_role_type

ALTER TABLE dbjudicialdata.judicial_role_type ADD CONSTRAINT per_id_fk
FOREIGN KEY (per_id) REFERENCES dbjudicialdata.judicial_user_profile(per_id);
