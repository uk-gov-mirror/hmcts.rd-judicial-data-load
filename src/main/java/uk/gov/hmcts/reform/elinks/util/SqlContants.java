...
public class SqlContants {
    ...
    public static final String SELECT_JOB_STATUS_SQL = "SELECT id, publishing_status FROM dbjudicialdata.dataload_schedular_job WHERE DATE(job_start_time) = current_date and publishing_status = 'IN_PROGRESS'";
